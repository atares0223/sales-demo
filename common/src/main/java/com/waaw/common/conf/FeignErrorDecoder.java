    ...
    public Exception decode(String methodKey, Response response) {
        ...
        try {
            ...
            if (exception instanceof FeignException feignException && feignException.responseBody().isPresent()) {
                ...
                String bodyText = StandardCharsets.UTF_8.newDecoder().decode(responseBody.asReadOnlyBuffer())
                        .toString();
                ...
                String message = Optional.ofNullable(exceptionInfo.getMessage())
                        .orElse(ResultCodeEnum.ERROR.getMessage());
